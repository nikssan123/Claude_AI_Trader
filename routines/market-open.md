...
STEP 2 — Re-validate with live data:
  ...
  python scripts/alpaca.py quote <each planned ticker>
...
STEP 4 — Execute the buys (market orders, day TIF):
  python scripts/alpaca.py order '{"symbol":"SYM","qty":"N","side":"buy","type":"market","time_in_force":"day"}'
Wait for fill confirmation before placing the stop.

STEP 5 — Immediately place 10% trailing stop GTC for each new position:
  python scripts/alpaca.py order '{"symbol":"SYM","qty":"N","side":"sell","type":"trailing_stop","trail_percent":"10","time_in_force":"gtc"}'
If Alpaca rejects with PDT error, fall back to fixed stop 10% below entry:
  python scripts/alpaca.py order '{"symbol":"SYM","qty":"N","side":"sell","type":"stop","stop_price":"X.XX","time_in_force":"gtc"}'
...
STEP 7 — Notification: only if a trade was placed.
  python scripts/discord.py "Trades $DATE" "<tickers, shares, fill prices, one-line why>"
