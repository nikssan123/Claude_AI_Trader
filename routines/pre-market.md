...
no fluff. Treat paper orders as if real — the test is whether your decisions
...
python scripts/perplexity.py "<query>" for each:
...
STEP 5 — Notification: silent unless urgent.
  python scripts/discord.py "Pre-market $DATE" "<one line>"
